...
# -*- coding: utf-8 -*-
#
# vtkdatawidgets documentation build configuration file
#
...
_version_py = os.path.join(repo, 'vtkdatawidgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'vtkdatawidgetsdoc'
...
latex_documents = [
    (master_doc, 'vtkdatawidgets.tex', 'vtkdatawidgets Documentation',
     'Simula Research Laboratory', 'manual'),
]
